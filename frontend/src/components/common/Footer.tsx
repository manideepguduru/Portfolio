    ...
    <footer className={styles.footer}>
      <div className={styles.inner}>
        <div className={styles.top}>
          <div className={styles.brand}>
            ...
            <div className={styles.socials}>
              ...
              <a href="https://www.linkedin.com/in/manideep-guduru/" target="_blank" rel="noopener" aria-label="LinkedIn" title="LinkedIn">
              ...
              <a href="https://github.com/manideepguduru" target="_blank" rel="noopener" aria-label="GitHub" title="GitHub">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className={styles.col}>
            ...
            <Link to="/services">Resume Consultancy</Link>
        ...
        <div className={styles.bottom}>
          <p>© {new Date().getFullYear()} Guduru Manideep. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
