        ...
        <div className={styles.top}>
          <div className={styles.brand}>
            ...
            <div className={styles.socials}>
              ...
              <a href="https://www.linkedin.com/in/manideepguduru" target="_blank" rel="noopener" aria-label="LinkedIn" title="LinkedIn">
              ...
              <a href="https://github.com/manideep048" target="_blank" rel="noopener" aria-label="GitHub" title="GitHub">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
